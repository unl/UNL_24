...
class List_Stream extends WP_List_Table {
    ...
    function column_pic_thumbnail($item){
        ...
        //Build row actions
        $actions = array(
            'post'      => sprintf('<a href="?page=%s&action=%s&image=%s">Post</a>',$_REQUEST['page'].'&stream='.$_GET['stream'],'post-instagrammer',$item['id'])
        );
        
        //Return the title contents
        return sprintf('<img src="'.$item['pic_thumbnail'] .'" width="150">%1$s',
    ...
    function get_columns(){
        $columns = array(
            ...
            'id'            => 'id',
            'pic_thumbnail' => 'Thumbnail',
            'pic_link'      => 'Link',
            'pic_timestamp' => 'Posted',
            'time_added'    => 'Added',
            'caption'       => 'Caption',
            'tags'          => 'Tags',
    ...
    function prepare_items() {
        ...
        $data = Database::get_images($_GET['stream'], array('return' => ARRAY_A));
