...
class List_Streams extends WP_List_Table {
    ...
    function column_name($item){
        ...
        $actions = array(
            ...
            'delete'    => sprintf('<a href="?page=%s&action=%s&streamid=%s">Delete</a>',$_REQUEST['page'],'instagrabber-delete-stream',$item['id']),
    ...
    function get_bulk_actions() {
        $actions = array(
            'instagrabber-delete-stream'    => 'Delete'
        );
        return $actions;
    }
    ...
    function prepare_items() {
        ...
        $data = Database::get_streams(array('return' => ARRAY_A));
